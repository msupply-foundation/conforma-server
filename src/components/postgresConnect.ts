...
class PostgresDB {
  ...
  public getReviewAssignmentById = async (reviewAssignmentId: number) => {
    const text = `
  ...
  public getMatchingReviewAssignments = async (
  ...
  public updateReviewAssignments = async (reviewAssignments: any) => {
