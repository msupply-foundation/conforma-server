...
export const TEMPLATE_TEMP_FOLDER_NAME = '__TEMP_Template_Output'
...
export const TEMPLATE_TEMP_FOLDER = path.join(getAppEntryPointDir(), TEMPLATE_TEMP_FOLDER_NAME)
