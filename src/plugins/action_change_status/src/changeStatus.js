    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          if (
            (currentStatus === null || currentStatus === void 0 ? void 0 : currentStatus.status) ===
            newStatus
          ) {
            // Do nothing
            console.log(
        ...
        case 3:
          ...
          if (!result_1) {
            ...
            return [2 /*return*/, returnObject]
          } else currentStageHistoryId = result_1.id
          return [3 /*break*/, 5]
        case 4:
        ...
        case 5:
          return [
            4 /*yield*/,
            DBConnect.addNewApplicationStatusHistory(currentStageHistoryId, newStatus),
          ]
        case 6:
          result = _a.sent()
          if (result.id) {
          ...
          returnObject.output = __assign(__assign({}, returnObject.output), {
