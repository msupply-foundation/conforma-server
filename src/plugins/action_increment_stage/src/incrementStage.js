    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          currentStageHistoryId =
            currentStageHistory === null || currentStageHistory === void 0
              ? void 0
              : currentStageHistory.stage_history_id
          currentStageNum =
            currentStageHistory === null || currentStageHistory === void 0
              ? void 0
              : currentStageHistory.stage_number
          currentStatus =
            currentStageHistory === null || currentStageHistory === void 0
              ? void 0
              : currentStageHistory.status
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            DBConnect.addNewApplicationStatusHistory(currentStageHistoryId, 'Completed'),
          ]
        case 5:
          result = _a.sent()
          if (!result) {
        ...
        case 6:
          return [
            4 /*yield*/,
            DBConnect.addNewStageHistory(applicationId, nextStage.stage_id),
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            DBConnect.addNewApplicationStatusHistory(
              newStageHistoryId,
        ...
        case 8:
          ...
          console.log(
            'Application ' +
              applicationId +
              ' Stage incremented to ' +
              returnObject.output.stageName +
              '. Status: ' +
              returnObject.output.status
          )
          return [2 /*return*/, returnObject]
        case 9:
          err_1 = _a.sent()
