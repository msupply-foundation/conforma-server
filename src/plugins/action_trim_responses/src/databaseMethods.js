...
var databaseMethods = function (DBConnect) { return ({
    ...
    deleteApplicationResponses: function (responsesToDelete) { return __awaiter(void 0, void 0, void 0, function () {
        var deletedCodes, _i, responsesToDelete_1, responseId, text, result, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    deletedCodes = [];
                    _i = 0, responsesToDelete_1 = responsesToDelete;
                    _a.label = 1;
                case 1:
                    if (!(_i < responsesToDelete_1.length)) return [3 /*break*/, 6];
                    responseId = responsesToDelete_1[_i];
                    text = "DELETE from application_response\n      WHERE id = $1\n      RETURNING (SELECT code FROM\n      template_element WHERE id = template_element_id)\n      ";
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, DBConnect.query({ text: text, values: [responseId] })];
                case 3:
                    result = _a.sent();
                ...
                case 4:
                    err_3 = _a.sent();
                    deletedCodes.push(err_3.message);
                    throw err_3;
                case 5:
                    _i++;
                    return [3 /*break*/, 1];
                case 6: return [2 /*return*/, deletedCodes];
            }
        });
    }); },
    deleteReviewResponses: function (responsesToDelete) { return __awaiter(void 0, void 0, void 0, function () {
        var deletedCodes, _i, responsesToDelete_2, responseId, text, result, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    deletedCodes = [];
                    _i = 0, responsesToDelete_2 = responsesToDelete;
                    _a.label = 1;
                case 1:
                    if (!(_i < responsesToDelete_2.length)) return [3 /*break*/, 6];
                    responseId = responsesToDelete_2[_i];
                ...
                case 4:
                    err_4 = _a.sent();
                    deletedCodes.push(err_4.message);
                    throw err_4;
                case 5:
                    _i++;
                    return [3 /*break*/, 1];
