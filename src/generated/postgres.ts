...
const evaluator_fragment = {
  ...
  columns: ['id', 'name', 'expression', 'metadata', 'front_end', 'back_end', 'permission_names', 'checksum', 'last_modified'],
  requiredForInsert: ['name', 'expression'],
  primaryKey: 'id',
  foreignKeys: {},
...
export interface Template {
  ...
  stale_draft_retention_days: number | null;
}
...
const template = {
  tableName: 'template',
  columns: ['id', 'name', 'name_plural', 'code', 'is_linear', 'can_applicant_make_changes', 'start_message', 'status', 'submission_message', 'icon', 'template_category_id', 'version_timestamp', 'serial_pattern', 'dashboard_restrictions', 'version_id', 'parent_version_id', 'version_comment', 'version_history', 'priority', 'linked_entity_data', 'stale_draft_retention_days'],
...
// Table template_evaluator_fragment_join
export interface TemplateEvaluatorFragmentJoin {
  id: number;
  template_id: number;
  evaluator_fragment_id: number;
}
export interface TemplateEvaluatorFragmentJoinInput {
  id?: number;
  template_id: number;
  evaluator_fragment_id: number;
}
const template_evaluator_fragment_join = {
  tableName: 'template_evaluator_fragment_join',
  columns: ['id', 'template_id', 'evaluator_fragment_id'],
  requiredForInsert: ['template_id', 'evaluator_fragment_id'],
  primaryKey: 'id',
  foreignKeys: {
    template_id: { table: 'template', column: 'id', $type: null as unknown as Template },
    evaluator_fragment_id: { table: 'evaluator_fragment', column: 'id', $type: null as unknown as EvaluatorFragment },
  },
  $type: null as unknown as TemplateEvaluatorFragmentJoin,
  $input: null as unknown as TemplateEvaluatorFragmentJoinInput
} as const;
...
export interface TableTypes {
  ...
  template_evaluator_fragment_join: {
    select: TemplateEvaluatorFragmentJoin;
    input: TemplateEvaluatorFragmentJoinInput;
  };
  template_file_join: {
