...
export interface DataTableContainerInput {
  id?: number;
  code?: string | null;
  long_description?: string | null;
  short_description?: string | null;
}
const data_table_container = {
  tableName: 'data_table_container',
  columns: ['id', 'code', 'long_description', 'short_description'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
  $type: null as unknown as DataTableContainer,
  $input: null as unknown as DataTableContainerInput
} as const;
...
const data_table_country = {
  ...
  columns: ['id', 'name_common', 'name_official', 'flag', 'who_sra_pics'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
...
// Table data_table_dosage_form_group
export interface DataTableDosageFormGroup {
  id: number;
  dosage_form_groups: string | null;
}
export interface DataTableDosageFormGroupInput {
  id?: number;
  dosage_form_groups?: string | null;
}
const data_table_dosage_form_group = {
  tableName: 'data_table_dosage_form_group',
  columns: ['id', 'dosage_form_groups'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
  $type: null as unknown as DataTableDosageFormGroup,
  $input: null as unknown as DataTableDosageFormGroupInput
} as const;

// Table data_table_generic_ingredient
export interface DataTableGenericIngredient {
  id: number;
  product_en: string | null;
  product_fr: string | null;
  who_atc_id: string | null;
  atc_code: string | null;
  name: string | null;
  category: string | null;
}
export interface DataTableGenericIngredientInput {
  id?: number;
  product_en?: string | null;
  product_fr?: string | null;
  who_atc_id?: string | null;
...
const data_table_generic_ingredient = {
  tableName: 'data_table_generic_ingredient',
  columns: ['id', 'product_en', 'product_fr', 'who_atc_id', 'atc_code', 'name', 'category'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
  $type: null as unknown as DataTableGenericIngredient,
  $input: null as unknown as DataTableGenericIngredientInput
} as const;
...
const data_table_manufacturer = {
  ...
  columns: ['id', 'manufacturer', 'country', 'address', 'is_additional'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
...
// Table data_table_manufacturer_application_join
export interface DataTableManufacturerApplicationJoin {
  id: number;
  application_id: number;
  data_table_manufacturer_id: number;
}
export interface DataTableManufacturerApplicationJoinInput {
  id?: number;
  application_id: number;
  data_table_manufacturer_id: number;
}
const data_table_manufacturer_application_join = {
  tableName: 'data_table_manufacturer_application_join',
  columns: ['id', 'application_id', 'data_table_manufacturer_id'],
  requiredForInsert: ['application_id', 'data_table_manufacturer_id'],
  primaryKey: 'id',
  foreignKeys: {
    application_id: { table: 'application', column: 'id', $type: null as unknown as Application },
    data_table_manufacturer_id: { table: 'data_table_manufacturer', column: 'id', $type: null as unknown as DataTableManufacturer },
  },
  $type: null as unknown as DataTableManufacturerApplicationJoin,
  $input: null as unknown as DataTableManufacturerApplicationJoinInput
} as const;

// Table data_table_manufacturer_representative
export interface DataTableManufacturerRepresentative {
  id: number;
  is_active: boolean | null;
  prequalification_date: Date | null;
  manufacturer_database_id: number | null;
  manufacturer_registration_id: string | null;
  name: string | null;
  address: string | null;
  country: string | null;
  gmp_scope: Json | null;
  ...
  manufacturing_licence: Json | null;
  letter_of_authorization: Json | null;
  manufacturing_companies: Json | null;
  evaluation_notes: string | null;
  gmp_by_who_certificate: Json | null;
  gmp_details: Json | null;
  gmp_expiry_1: Date | null;
  gmp_expiry_2: Date | null;
  gmp_country_1: string | null;
  gmp_country_2: string | null;
  gmp_expiry_3: Date | null;
  gmp_country_3: string | null;
  additional_certifications: Json | null;
}
export interface DataTableManufacturerRepresentativeInput {
  id?: number;
  is_active?: boolean | null;
  prequalification_date?: Date | null;
  manufacturer_database_id?: number | null;
...
const data_table_manufacturer_representative = {
  tableName: 'data_table_manufacturer_representative',
  columns: ['id', 'is_active', 'prequalification_date', 'manufacturer_database_id', 'manufacturer_registration_id', 'name', 'address', 'country', 'gmp_scope', 'company_id', 'applicant_id', 'company_name', 'gmp_certificate', 'manufacturing_licence', 'letter_of_authorization', 'manufacturing_companies', 'evaluation_notes', 'gmp_by_who_certificate', 'gmp_details', 'gmp_expiry_1', 'gmp_expiry_2', 'gmp_country_1', 'gmp_country_2', 'gmp_expiry_3', 'gmp_country_3', 'additional_certifications'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
  $type: null as unknown as DataTableManufacturerRepresentative,
  $input: null as unknown as DataTableManufacturerRepresentativeInput
} as const;

// Table data_table_manufacturer_representative_application_join
export interface DataTableManufacturerRepresentativeApplicationJoin {
  id: number;
  application_id: number;
  data_table_manufacturer_representative_id: number;
}
export interface DataTableManufacturerRepresentativeApplicationJoinInput {
  id?: number;
  application_id: number;
  data_table_manufacturer_representative_id: number;
}
const data_table_manufacturer_representative_application_join = {
  tableName: 'data_table_manufacturer_representative_application_join',
  columns: ['id', 'application_id', 'data_table_manufacturer_representative_id'],
  requiredForInsert: ['application_id', 'data_table_manufacturer_representative_id'],
  primaryKey: 'id',
  foreignKeys: {
    application_id: { table: 'application', column: 'id', $type: null as unknown as Application },
    data_table_manufacturer_representative_id: { table: 'data_table_manufacturer_representative', column: 'id', $type: null as unknown as DataTableManufacturerRepresentative },
  },
  $type: null as unknown as DataTableManufacturerRepresentativeApplicationJoin,
  $input: null as unknown as DataTableManufacturerRepresentativeApplicationJoinInput
} as const;

// Table data_table_permit_chemical
export interface DataTablePermitChemical {
  id: number;
  ...
  company_id: number | null;
  company_name: string | null;
  chemicals_filter_data: string | null;
}
export interface DataTablePermitChemicalInput {
  id?: number;
  permit_no?: string | null;
  registration_date?: Date | null;
  chemicals?: Json | null;
...
const data_table_permit_chemical = {
  tableName: 'data_table_permit_chemical',
  columns: ['id', 'permit_no', 'registration_date', 'chemicals', 'company_id', 'company_name', 'chemicals_filter_data'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
  $type: null as unknown as DataTablePermitChemical,
  $input: null as unknown as DataTablePermitChemicalInput
} as const;

// Table data_table_permit_chemical_application_join
export interface DataTablePermitChemicalApplicationJoin {
  id: number;
  application_id: number;
  data_table_permit_chemical_id: number;
}
export interface DataTablePermitChemicalApplicationJoinInput {
  id?: number;
  application_id: number;
  data_table_permit_chemical_id: number;
}
const data_table_permit_chemical_application_join = {
  tableName: 'data_table_permit_chemical_application_join',
  columns: ['id', 'application_id', 'data_table_permit_chemical_id'],
  requiredForInsert: ['application_id', 'data_table_permit_chemical_id'],
  primaryKey: 'id',
  foreignKeys: {
    application_id: { table: 'application', column: 'id', $type: null as unknown as Application },
    data_table_permit_chemical_id: { table: 'data_table_permit_chemical', column: 'id', $type: null as unknown as DataTablePermitChemical },
  },
  $type: null as unknown as DataTablePermitChemicalApplicationJoin,
  $input: null as unknown as DataTablePermitChemicalApplicationJoinInput
} as const;
...
// Table data_table_prequal_manufacturer
export interface DataTablePrequalManufacturer {
  id: number;
...
export interface DataTablePrequalManufacturerInput {
  id?: number;
  lookup_id?: number | null;
  is_active?: boolean | null;
  manufacturer_id?: string | null;
...
const data_table_prequal_manufacturer = {
  tableName: 'data_table_prequal_manufacturer',
  columns: ['id', 'lookup_id', 'is_active', 'manufacturer_id', 'prequalification_date', 'name', 'address', 'country', 'gmp_scope', 'permit_no', 'date_issued', 'manufacturing_licence', 'gmp_details'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
  $type: null as unknown as DataTablePrequalManufacturer,
  $input: null as unknown as DataTablePrequalManufacturerInput
} as const;

// Table data_table_prequal_manufacturer_application_join
export interface DataTablePrequalManufacturerApplicationJoin {
  id: number;
  application_id: number;
  data_table_prequal_manufacturer_id: number;
}
export interface DataTablePrequalManufacturerApplicationJoinInput {
  id?: number;
  application_id: number;
  data_table_prequal_manufacturer_id: number;
}
const data_table_prequal_manufacturer_application_join = {
  tableName: 'data_table_prequal_manufacturer_application_join',
  columns: ['id', 'application_id', 'data_table_prequal_manufacturer_id'],
  requiredForInsert: ['application_id', 'data_table_prequal_manufacturer_id'],
  primaryKey: 'id',
  foreignKeys: {
    application_id: { table: 'application', column: 'id', $type: null as unknown as Application },
    data_table_prequal_manufacturer_id: { table: 'data_table_prequal_manufacturer', column: 'id', $type: null as unknown as DataTablePrequalManufacturer },
  },
  $type: null as unknown as DataTablePrequalManufacturerApplicationJoin,
  $input: null as unknown as DataTablePrequalManufacturerApplicationJoinInput
} as const;

// Table data_table_processing_step
export interface DataTableProcessingStep {
  id: number;
  processing_step: string | null;
}
export interface DataTableProcessingStepInput {
  id?: number;
  processing_step?: string | null;
}
const data_table_processing_step = {
  tableName: 'data_table_processing_step',
  columns: ['id', 'processing_step'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
  $type: null as unknown as DataTableProcessingStep,
  $input: null as unknown as DataTableProcessingStepInput
} as const;
...
export interface DataTableProduct {
  ...
  active_substances: Json | null;
  primary_container: string | null;
  administration_unit: string | null;
  storage_temperature: string | null;
  proposed_indications: string | null;
  component_formulation: string | null;
  packaging_description: string | null;
  dosage_form_description: string | null;
  route_of_administration: string | null;
  finished_product_manufacturers: string | null;
  national_medical_classification: string | null;
  active_ingredients_manufacturers: string | null;
  company_id: number | null;
}
...
const data_table_product = {
  ...
  columns: ['id', 'expiry_date', 'product_origin', 'registration_date', 'registration_serial', 'sra', 'name', 'atc_code', 'shelf_life', 'dosage_form', 'atc_category', 'company_name', 'formulations', 'company_phone', 'company_address', 'packaging_sizes', 'importer_address', 'active_substances', 'primary_container', 'administration_unit', 'storage_temperature', 'proposed_indications', 'component_formulation', 'packaging_description', 'dosage_form_description', 'route_of_administration', 'finished_product_manufacturers', 'national_medical_classification', 'active_ingredients_manufacturers', 'company_id'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
...
export interface DataTableProvisionalProduct {
  ...
  manufacturer_prequalified: Json | null;
  loa_source: string | null;
  letter_of_authorisation: Json | null;
  packaging_sizes_form: Json | null;
  ...
  manufacturer_non_prequal_justification: Json | null;
  loa_authoriser_name: string | null;
}
...
const data_table_provisional_product = {
  ...
  columns: ['id', 'full_name', 'is_active', 'product_id', 'dosage_form', 'original_id', 'expiry_date', 'sponsor_name', 'registered_in', 'registration_date', 'registration_serial', 'route_of_administration', 'trade_name', 'company_id', 'shelf_life', 'applicant_id', 'company_name', 'packaging_sizes', 'storage_conditions', 'active_ingredients', 'medical_product_classification', 'manufacturers', 'atc_code', 'pharmacopeia', 'gmp_certificate', 'prod_reg_certificate', 'prequalified', 'manufacturer_prequalified', 'loa_source', 'letter_of_authorisation', 'packaging_sizes_form', 'packaging_sizes_filter_data', 'manufacturers_filter_data', 'active_ingredients_filter_data', 'gmp_details', 'approval', 'evaluation_comment', 'manufacturer_non_prequal_justification', 'loa_authoriser_name'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
...
// Table data_table_storage_condition
export interface DataTableStorageCondition {
  id: number;
  code: string | null;
  long_description: string | null;
  short_description: string | null;
}
export interface DataTableStorageConditionInput {
  id?: number;
  code?: string | null;
  long_description?: string | null;
  short_description?: string | null;
}
const data_table_storage_condition = {
  tableName: 'data_table_storage_condition',
  columns: ['id', 'code', 'long_description', 'short_description'],
  requiredForInsert: [],
  primaryKey: 'id',
  foreignKeys: {},
  $type: null as unknown as DataTableStorageCondition,
  $input: null as unknown as DataTableStorageConditionInput
} as const;
...
export interface TableTypes {
  ...
  data_table_container: {
    select: DataTableContainer;
    input: DataTableContainerInput;
  };
  data_table_country: {
  ...
  data_table_dosage_form_group: {
    select: DataTableDosageFormGroup;
    input: DataTableDosageFormGroupInput;
  };
  data_table_generic_ingredient: {
    select: DataTableGenericIngredient;
    input: DataTableGenericIngredientInput;
  };
  data_table_manufacturer: {
    select: DataTableManufacturer;
    input: DataTableManufacturerInput;
  };
  data_table_manufacturer_application_join: {
    select: DataTableManufacturerApplicationJoin;
    input: DataTableManufacturerApplicationJoinInput;
  };
  data_table_manufacturer_representative: {
    select: DataTableManufacturerRepresentative;
    input: DataTableManufacturerRepresentativeInput;
  };
  data_table_manufacturer_representative_application_join: {
    select: DataTableManufacturerRepresentativeApplicationJoin;
    input: DataTableManufacturerRepresentativeApplicationJoinInput;
  };
  data_table_permit_chemical: {
    select: DataTablePermitChemical;
    input: DataTablePermitChemicalInput;
  };
  data_table_permit_chemical_application_join: {
    select: DataTablePermitChemicalApplicationJoin;
    input: DataTablePermitChemicalApplicationJoinInput;
  };
  ...
  data_table_prequal_manufacturer: {
    select: DataTablePrequalManufacturer;
    input: DataTablePrequalManufacturerInput;
  };
  data_table_prequal_manufacturer_application_join: {
    select: DataTablePrequalManufacturerApplicationJoin;
    input: DataTablePrequalManufacturerApplicationJoinInput;
  };
  data_table_processing_step: {
    select: DataTableProcessingStep;
    input: DataTableProcessingStepInput;
  };
  data_table_product: {
  ...
  data_table_storage_condition: {
    select: DataTableStorageCondition;
    input: DataTableStorageConditionInput;
  };
