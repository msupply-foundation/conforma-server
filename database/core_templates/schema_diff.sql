...
--- BEGIN ALTER FUNCTION "public"."application_list"(integer) ---
...
COMMENT ON FUNCTION "public"."application_list"(integer)  IS '@sortable';
...
--- BEGIN ALTER FUNCTION "public"."review_list"(integer, integer, application_status) ---

DROP FUNCTION IF EXISTS "public"."review_list"(integer, integer, application_status);

CREATE OR REPLACE FUNCTION public.review_list(stageid integer, reviewerid integer, appstatus application_status)
...
AS $function$
    ...
    $function$
;
ALTER FUNCTION "public"."review_list"(integer, integer, application_status) OWNER TO postgres;

COMMENT ON FUNCTION "public"."review_list"(integer, integer, application_status)  IS NULL;

--- END ALTER FUNCTION "public"."review_list"(integer, integer, application_status) ---

--- BEGIN CREATE FUNCTION "public"."review_list"(integer, integer) ---
...
--- END CREATE FUNCTION "public"."review_list"(integer, integer) ---
...
COMMENT ON FUNCTION "public"."deadline_extension_activity_log"()  IS NULL;
