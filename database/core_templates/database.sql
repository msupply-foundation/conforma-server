...
ALTER TABLE IF EXISTS ONLY public.review DROP CONSTRAINT IF EXISTS review_review_assignment_id_key;
...
DROP VIEW IF EXISTS public.assigned_sections_by_stage_and_level;
DROP VIEW IF EXISTS public.unnested_sections;
...
CREATE TABLE public.template (
    ...
    serial_pattern character varying
);
...
--
-- Name: unnested_sections; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.unnested_sections AS
 SELECT review_assignment.id,
    unnest(review_assignment.assigned_sections) AS section
   FROM public.review_assignment;


ALTER TABLE public.unnested_sections OWNER TO postgres;

--
-- Name: assigned_sections_by_stage_and_level; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.assigned_sections_by_stage_and_level AS
 SELECT review_assignment.application_id,
    review_assignment.stage_id,
    review_assignment.level_number,
    review_assignment_assigner_join.assigner_id,
    count(DISTINCT unnested_sections.section) FILTER (WHERE (review_assignment.status = 'ASSIGNED'::public.review_assignment_status)) AS assigned_section_for_level,
    count(DISTINCT unnested_sections.section) FILTER (WHERE (((review_assignment.status = 'ASSIGNED'::public.review_assignment_status) AND (review_status_history.status IS NULL)) OR (review_status_history.status <> 'SUBMITTED'::public.review_status))) AS assigned_in_progress_sections
   FROM ((((public.review_assignment
     JOIN public.review_assignment_assigner_join ON ((review_assignment_assigner_join.review_assignment_id = review_assignment.id)))
     LEFT JOIN public.unnested_sections ON ((unnested_sections.id = review_assignment.id)))
     LEFT JOIN public.review ON ((review.review_assignment_id = review_assignment.id)))
     LEFT JOIN public.review_status_history ON (((review.id = review_status_history.review_id) AND (review_status_history.is_current = true))))
  GROUP BY review_assignment.application_id, review_assignment.stage_id, review_assignment.level_number, review_assignment_assigner_join.assigner_id;


ALTER TABLE public.assigned_sections_by_stage_and_level OWNER TO postgres;
...
INSERT INTO public.action_plugin VALUES (24, 'updateReviewStatuses', 'Update Review Statuses', 'Updates status of associated reviews when applications and reviews are submitted', '../plugins/action_update_review_status/src/index.ts', '{changedResponses}', '{applicationId,reviewId,triggeredBy}', '{updatedReviews}');
...
INSERT INTO public.activity_log VALUES (4, 'PERMISSION', 'Granted', '2022-12-20 11:22:30.990318+13', NULL, 'permission_join', 16, '{"user": {"id": 2, "name": "Admin Admin", "username": "admin"}, "isActive": true, "permission": {"id": 8, "name": "reviewGeneral"}, "organisation": {"id": 1, "name": "Food and Drug Authority"}}');
...
INSERT INTO public.permission_join VALUES (16, 2, 1, 8, true);
...
INSERT INTO public.system_info VALUES (26, 'version', '"0.5.0-11"', '2022-12-09 17:10:48.556875+13');
...
INSERT INTO public.template VALUES (9, 'Demo -- Feature Showcase', 'Demo -- Feature Showcases', 'Demo', false, true, '{"children": ["## This is the general registration for feature showcase\nHi, %1. You will need to provide:\n- Proof of identity (Passport, Drivers license)\n- Proof of your medical certification\n- Drug ingredient list\n- Product images\n- Packging images", {"children": ["currentUser.firstName"], "operator": "objectProperties"}], "operator": "stringSubstitution"}', 'AVAILABLE', '{"children": ["### Application Submitted!\nThanks, %1.", {"children": ["currentUser.firstName"], "operator": "objectProperties"}], "operator": "stringSubstitution"}', NULL, 1, '2021-09-08 19:33:01.96505+12', 2, NULL);
INSERT INTO public.template VALUES (1, 'Edit User Details', 'Edit Users Details', 'UserEdit', true, true, NULL, 'AVAILABLE', '"Thanks for updating your details. You will need to log out and log back into the system for the changes to take effect."', NULL, 4, '2021-08-10 14:13:36.778636+12', 1, 'UE-[A-Z]{3}-<+dddd>');
INSERT INTO public.template VALUES (2, 'User Registration', NULL, 'UserRegistration', true, true, NULL, 'AVAILABLE', '"Thanks. Please check your email to verify your registration."', NULL, NULL, '2021-08-10 14:13:37.055372+12', 1, 'UR-[A-Z]{3}-<+dddd>');
INSERT INTO public.template VALUES (7, 'Company Registration', 'Company Registrations', 'OrgRegistration', true, true, '"## You will need the following documents ready for upload:\n- Proof of organisation name\n- Proof of organisation address\n- Organisation licence document"', 'AVAILABLE', '"Thank you! Your application has been submitted."', NULL, 2, '2021-09-08 19:31:58.620695+12', 3, NULL);
INSERT INTO public.template VALUES (8, 'Join Company', NULL, 'OrgJoin', false, false, '"## You will need the following documents ready for upload:\n- PhotoID"', 'AVAILABLE', '"Thank you! Your application has been submitted."', NULL, 2, '2021-09-08 19:32:36.975294+12', 2, NULL);
INSERT INTO public.template VALUES (11, 'Reset Password', '', 'PasswordReset', false, true, NULL, 'AVAILABLE', '{"children": [{"children": [1, {"children": ["applicationData.current.stage.number", null], "operator": "objectProperties"}], "operator": "="}, "Thanks. Please click the link sent your email to change your password.", "Password changed"], "operator": "?"}', NULL, NULL, '2021-09-08 12:43:22.001461+12', 2, '[A-Za-z0-9]{24}');
INSERT INTO public.template VALUES (12, 'Grant User Permissions', NULL, 'grantUserPermissions', true, false, '""', 'AVAILABLE', '"Thank you! Permissions have been updated."', NULL, 7, '2021-08-16 20:28:45.381906+12', 1, 'P-[A-Z]{3}-<+dddd>');
INSERT INTO public.template VALUES (13, 'Add User to Company', NULL, 'addToCompany', true, false, '""', 'AVAILABLE', '"Thank you! User has been added."', NULL, 7, '2021-09-22 16:18:42.49605+12', 1, 'P-[A-Z]{3}-<+dddd>');
INSERT INTO public.template VALUES (10, 'Sample Templates', 'Sample template applications', 'CoreActions', true, true, '"## You will need the following documents ready for upload:\n- <Add list of documents to upload>"', 'AVAILABLE', '"Thank you! Your application has been submitted."', NULL, 1, '2021-09-08 19:33:33.648821+12', 2, NULL);
...
INSERT INTO public.template_action VALUES (13, 2, NULL, 'modifyRecord', NULL, 'ON_VERIFICATION', 'true', '{"email": {"children": ["applicationData.responses.Q4Email.text"], "operator": "objectProperties"}, "username": {"children": ["applicationData.responses.Q3Username.text"], "operator": "objectProperties"}, "last_name": {"children": ["applicationData.responses.Q2LastName.text"], "operator": "objectProperties"}, "tableName": "user", "first_name": {"children": ["applicationData.responses.Q1FirstName.text"], "operator": "objectProperties"}, "password_hash": {"children": ["applicationData.responses.Q5Password.hash"], "operator": "objectProperties"}}', 'Create User record', 1);
...
"templateName: username - serial"', 4);
INSERT INTO public.template_action VALUES (4, 1, NULL, 'modifyRecord', NULL, 'ON_APPLICATION_SUBMIT', 'true', '{"id": {"children": ["applicationData.userId"], "operator": "objectProperties"}, "email": {"children": ["applicationData.responses.Q4.text"], "operator": "objectProperties"}, "username": {"children": ["applicationData.responses.Q3.text"], "operator": "objectProperties"}, "last_name": {"children": ["applicationData.responses.Q2.text"], "operator": "objectProperties"}, "tableName": "user", "first_name": {"children": ["applicationData.responses.Q1.text"], "operator": "objectProperties"}, "password_hash": {"children": [{"children": ["applicationData.responses.passwordCheckbox.values.0.selected"], "operator": "objectProperties"}, {"children": ["applicationData.responses.newPassword.hash"], "operator": "objectProperties"}, null], "operator": "?"}}', 'Update details in "User" table', 1);
INSERT INTO public.template_action VALUES (169, 8, NULL, 'modifyRecord', NULL, 'ON_APPLICATION_SUBMIT', 'true', '{"id": {"children": ["applicationData.applicationId"], "operator": "objectProperties"}, "org_id": {"children": ["applicationData.responses.S1Q1.selection.id"], "operator": "objectProperties"}, "tableName": "application"}', 'Associate this application with the organisation that was selected in the form', NULL);
INSERT INTO public.template_action VALUES (219, 10, NULL, 'modifyRecord', NULL, 'ON_REVIEW_SUBMIT', '{"children": [{"children": ["applicationData.outcome"], "operator": "objectProperties"}, "APPROVED"], "operator": "="}', '{"data": {"name": "responses.name.text", "address": "responses.physAdd.text", "registration": "responses.rego.text", "registration_documentation": "responses.regoDoc"}, "logo_url": {"type": "string", "children": ["applicationData.responses.logo.files.fileUrl"], "fallback": null, "operator": "objectProperties"}, "tableName": "organisation"}', 'Example: action to modify record in database using fields from application when outcome is change to APPROVED ', 101);
...
INSERT INTO public.template_element VALUES (175, 19, 'password', 41, 'New Element', 'QUESTION', 'password', '{"children": [2, {"children": ["applicationData.current.stage.number", null], "operator": "objectProperties"}], "operator": "="}', 'true', 'true', 'true', '"Any default value here will prevent response from being deleted by \"trimResponses\" action after first submission"', '', NULL, '{"label": "New password", "maskedInput": true, "placeholder": "Password must be at least 6 chars long", "validationInternal": {"children": [{"children": ["responses.thisResponse"], "operator": "objectProperties"}, {"value": "^[\\S]{6,}$"}], "operator": "REGEX"}, "validationMessageInternal": "Password must be at least 6 characters"}', 'ONLY_IF_APPLICANT_ANSWER', DEFAULT, DEFAULT);
...
SELECT pg_catalog.setval('public.action_plugin_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.permission_join_id_seq', 16, true);
...
--
-- Name: review review_review_assignment_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE unnested_sections; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.unnested_sections TO graphile_user;


--
-- Name: TABLE assigned_sections_by_stage_and_level; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.assigned_sections_by_stage_and_level TO graphile_user;
