...
-- FUNCTION to auto-add stage_date to review
CREATE OR REPLACE FUNCTION public.review_stage_date (review_assignment_id int)
    RETURNS timestamptz
    AS $$
    SELECT
        stage_date
...
CREATE TABLE public.review (
    ...
    -- time_status_created viw review_status_history
    ...
    stage_date timestamptz GENERATED ALWAYS AS (public.review_stage_date (review_assignment_id)) STORED,
