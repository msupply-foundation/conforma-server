...
CREATE TYPE public.trigger as ENUM ('onApplicationCreate', 'onApplicationRestart', 'onApplicationSubmit', 'onApplicationSave', 'onApplicationWithdraw', 'onReviewCreate', 'onReviewSubmit', 'onReviewStart', 'onReviewAssign', 'onReviewSelfAssign', 'onApprovalSubmit', 'onScheduleTime', 'Processing', 'Error');
