...
test('Test: remove unchanged application_response duplicates', () => {
    return index_1.action({ parameters: { applicationId: 4001 }, DBConnect: databaseConnect_1.default }).then((result) => {
...
//# sourceMappingURL=trimResponses.test.js.map